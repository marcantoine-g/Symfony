 ...
 */
final class Version20190523205048 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE version (id INT AUTO_INCREMENT NOT NULL, numero INT NOT NULL, file VARCHAR(255) NOT NULL, is_valided TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
